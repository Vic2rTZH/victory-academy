                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${pct}%`, background: 'linear-gradient(90deg,#f5c842,#f5c842)' }}
                    />
                  </div>
                  <div className="flex gap-2 text-xs text-white/40">
                    <span>{goal.category}</span>
                    {goal.deadline && <span>Â· Due {new Date(goal.deadline).toLocaleDateString()}</span>}
                  </div>
                </div>
              ...
              {open && (
                <div className="px-4 pb-4 space-y-2 border-t border-white/10 pt-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 text-red-400/60 text-xs hover:text-red-400 mt-2"
                  >
